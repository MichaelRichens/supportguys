	...
	return (
		<Page title={"Privacy Policy"}>
			<article className="standard-text">
				...
				<p>
					At Support Guys, accessible from www.supportguys.co.uk, one
					of our main priorities is the privacy of our visitors. This
					Privacy Policy document contains types of information that
					is collected and recorded by Support Guys and how we use it.
				</p>
				<p>
				...
				<ul>
					<li>
						Second Chance PC Ltd needs to perform a contract with
						you
					</li>
					<li>
						You have given Second Chance PC Ltd permission to do so
					</li>
					<li>
						Processing your personal information is in Second Chance
						PC Ltd legitimate interests
					</li>
					<li>Second Chance PC Ltd needs to comply with the law</li>
				</ul>

				<p>
					Second Chance PC Ltd will retain your personal information
				...
				<p>
					...
					analysing trends, administering the site, tracking users'
				...
				<p>
					...
					respective advertisements and links that appear on Support
					Guys, which are sent directly to users' browser. They
				...
				<p>
					...
					information that they shared and/or collect in Support Guys.
